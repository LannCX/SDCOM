...
from arch.ops import DyChConv2d, DyChBatchNorm2d, DyChLinear, ShiftModule
...
class DyChBasicBlock(nn.Module):
    expansion = 1
...
class DyChResNet(nn.Module):
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=True):
        ...
        if zero_init_residual:
            for m in self.modules():
                if isinstance(m, DyChBottleneck) or isinstance(m, DyChBasicBlock):
...
def resnet18(pretrained=False, **kwargs):
    ...
    """
    model = DyChResNet(DyChBasicBlock, [2, 2, 2, 2], **kwargs)
    if pretrained:
...
def resnet34(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = DyChResNet(DyChBasicBlock, [3, 4, 6, 3], **kwargs)
    if pretrained:
...
def resnet101(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = DyChResNet(DyChBottleneck, [3, 4, 23, 3], **kwargs)
    if pretrained:
...
def resnet152(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = DyChResNet(DyChBottleneck, [3, 8, 36, 3], **kwargs)
    if pretrained:
